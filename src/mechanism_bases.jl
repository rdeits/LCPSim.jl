function planar_base()
    ...
    base_x.bounds.position .= Bounds(-10., 10)
    base_x.bounds.velocity .= Bounds(-10., 10)
    base_x.bounds.effort .= Bounds(0., 0)
    ...
    base_z.bounds.position .= Bounds(-10., 10)
    base_z.bounds.velocity .= Bounds(-10., 10)
    base_z.bounds.effort .= Bounds(0., 0)
...
function planar_revolute_base()
    ...
    joint.bounds.position .= Bounds(-π, π)
    joint.bounds.velocity .= Bounds(-2π, 2π)
    joint.bounds.effort .= Bounds(0., 0)
