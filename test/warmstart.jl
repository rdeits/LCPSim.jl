...
@testset "simulation warmstarts" begin
    ...
    @testset "linear dynamics" begin
        ...
        set_velocity!(x1, v0)
        results1 = LCPSim.simulate(x1, controller, env1, Δt, N, CbcSolver(); relinearize=false)
    ...
    @testset "nonlinear dynamics" begin
        ...
        set_configuration!(x1, q0)
        set_velocity!(x1, v0)
        results3 = LCPSim.simulate(x1, controller, env1, Δt, N, CbcSolver(); relinearize=true)
